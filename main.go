...
var httpconf = httpConfig{ip: "0.0.0.0", port: "8083", shutdownTimeout: 15, readTimeout: 60, writeTimeout: 60, listenString: "0.0.0.0:8083", logPath: "logs/", diagnosticsFile: "diagnostics.log", accessFile: "access.log"}
