...
import-check: $(GOFILES)
	@echo "  >  Valiate Go imports"
	@GOPATH=$(GOPATH) GOBIN=$(GOBIN) goimports -w $(GOFILES)
...
docker-build:
	...
	docker build -f manifests/Dockerfile -t pavedroad-io/eventbridgeinitdb .
